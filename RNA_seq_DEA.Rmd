...
To start the work we had to set our working directory to the directory, that contains the data. In my case the directory was called RNA_seq_DEA and is stored in the university home directory.
